...
#### Bug fixes
* Don't restart OneAgent Pods if OneAgent version has been downgraded and those Pods were already restarted ([#338](https://github.com/Dynatrace/dynatrace-oneagent-operator/pull/338))
