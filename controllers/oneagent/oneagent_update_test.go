...
func TestReconcile_InstallerDowngrade(t *testing.T) {
	...
	oa := dynatracev1alpha1.OneAgent{
		...
		// This version should be only informative, and not have any effect.
		Status: dynatracev1alpha1.OneAgentStatus{Version: "1.206.0.20200101-000000"},
	}
	...
	_, _ = r.reconcileVersionInstaller(context.TODO(), consoleLogger, &oa, dtcMock)
