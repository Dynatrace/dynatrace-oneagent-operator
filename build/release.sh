...
./kustomize build https://github.com/Dynatrace/dynatrace-oneagent-operator/deploy/kubernetes -o kubernetes.yaml
./kustomize build https://github.com/Dynatrace/dynatrace-oneagent-operator/deploy/openshift -o openshift.yaml
