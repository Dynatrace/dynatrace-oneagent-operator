...
go build -ldflags="-X 'github.com/Dynatrace/dynatrace-oneagent-operator.Version=${version}'" -tags containers_image_storage_stub -o ./build/_output/bin/dynatrace-oneagent-operator ./
